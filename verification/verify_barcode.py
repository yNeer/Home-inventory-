...
def run():
    with sync_playwright() as p:
        ...
        page_desktop.screenshot(path='verification/01_desktop_add_item_with_barcode_btn.png')
        ...
        page_mobile.screenshot(path='verification/02_mobile_add_item_with_barcode_btn.png')
